...
import com.easy.doc.constants.SpringMvcAnnotations;
import com.thoughtworks.qdox.model.JavaAnnotation;
import com.thoughtworks.qdox.model.expression.AnnotationValue;

import static com.easy.doc.constants.DocGlobalConstants.JSON_PROPERTY_READ_ONLY;
import static com.easy.doc.constants.DocGlobalConstants.JSON_PROPERTY_WRITE_ONLY;
...
public class JavaClassValidateUtil {
    ...
    public static boolean isJSR303Required(String annotationSimpleName) {
        if (StringUtil.isEmpty(annotationSimpleName)) {
            return false;
        }
